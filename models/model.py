...
class Informer(nn.Module):
    def __init__(self, enc_in, dec_in, c_out, seq_len, label_len, out_len,
                ...
                device=torch.device('cuda:0'), decoder_case=0):
        ...
        self.encoder = Encoder(
            [
                EncoderLayer(
                    ...
                    else AttentionLayer(Attn(False, factor, attention_dropout=dropout, output_attention=output_attention), d_model, n_heads, mix=False),
                    d_model,
                    d_ff,
                    dropout=dropout,
        ...
        self.decoder = Decoder(
            [
                DecoderLayer(
                    ...
                    else AttentionLayer(Attn(True, factor, attention_dropout=dropout, output_attention=False), 
